(module
 ...
 (global $~lib/util/casemap/SPECIALS_UPPER i32 (i32.const 304))
 (global $~lib/rt/__rtti_base i32 (i32.const 5920))
 (global $~lib/heap/__heap_base i32 (i32.const 5964))
 ...
 (export "newest_squiggle" (func $assembly/index/newest_squiggle))
 (export "new_squiggle" (func $assembly/index/new_squiggle))
 ...
 (func $assembly/index/newest_squiggle (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 f64)
  (local $4 f64)
  (local $5 i32)
 ...
 (func $assembly/index/new_squiggle (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 f64)
  (local $4 f64)
  (local $5 i32)
 ...
 (func $~lib/staticarray/StaticArray<u16>#__visit_impl (param $0 i32) (param $1 i32)
  i32.const 0
  drop
 )
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  ...
  block $switch$1$default
   ...
   local.get $0
   local.get $1
   call $~lib/staticarray/StaticArray<u16>#__visit_impl
   return
  end
  unreachable
 )
